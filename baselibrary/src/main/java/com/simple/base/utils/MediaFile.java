...
public class MediaFile {
     ...
     *根据路径判断改文件是否为视频文件
     */
    public static boolean isVideoFile(String path) {  //自己增加
     ...
     *根据路径判断改文件是否为音频文件
     */
    public static boolean isAudioFile(String path) {  //自己增加
        MediaFileType type = getFileType(path);
        if(null != type) {
     ...
     *根据路径判断改文件是否为图片文件
     */
    public static boolean isImageFile(String name) {  //自己增加 .jpeg
        if(!TextUtils.isEmpty(name)) {
           if (name.endsWith("jpg")||name.endsWith("png")||name.endsWith("jpeg")||name.endsWith("JPG")||name.endsWith("PNG")
                   ||name.endsWith("JPEG")){
               return  true;
           }
        }
...
//     *根据路径判断改文件是否为图片文件
//     */
//    public static boolean isImageFile(String path) {  //自己增加
//        MediaFileType type = getFileType(path);
//        if(null != type) {
